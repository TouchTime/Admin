<template>
  <div class="self-orders-box">
    ...
    <el-table v-loading="loading" :data="tableData">
      ...
      <el-table-column prop="discountSum" label="折扣金额" min-width="80" align="center"></el-table-column>
    ...
    <el-dialog title="订单明细" :visible.sync="dialogFormVisible" width="60%">
  ...
  export default  {
    ...
    methods : {
      ...
      exportExcel(){
        ...
        let queryStr = `type=2&`;
        sendData.startTime = (sendData.daterange && sendData.daterange[0]) ? moment(sendData.daterange[0]).format("YYYY-MM-DD HH:mm:ss") : '';
        sendData.endTime = (sendData.daterange && sendData.daterange[1]) ? moment(sendData.daterange[1]).format("YYYY-MM-DD HH:mm:ss") : '';
        ...
        window.location.href = `/platforms/platform/order/allexport?${queryStr}`;
      }
    }
  }
</script>
